                        ...
                        <td
                            ...
                            <body>
                                ...
                                <div class="center-text">
                                    <h2><strong>El período de postulación de tu oferta laboral ha finalizado.</strong></h2>
                                    <br>
                                    <p>Dado que tu oferta ha concluido, te presentamos a continuación información de aquellos que se postularon a esta oferta</p>
                                    <br>
                                    <p>Estimado/a <strong>${fullName}</strong>,</p>
                                    <br>
                                    <p>Has postulado a la oferta laboral <strong>${oferta.cargo}</strong> de la empresa <strong>${oferta.empresa.nombre}</strong> en el portal de
                                        empleo de la ISTA.</p>
                                    <br>
                                    <p>En los próximos días nos pondremos en contacto contigo para informarte sobre el
                                        proceso de selección.</p>
                                    <br>
                                    <p>¡Gracias por confiar en nosotros!</p>
                                    <p>El equipo de la ISTA.</p>
                                    <br>
                                </div>
                                <div class="center-icon">
