                        ...
                        <td
                            ...
                            <body>
                                <div class="center-icon">
                                	<img src="https://i.postimg.cc/HkthHpZb/marca-x.png" alt="marca-x" width="100px"/>
                                </div>
                                <div class="center-text">
                                    <h2><strong>Has cancelado tu oferta laboral</strong></h2>
                                    <br>
                                    <p>Saludos cordiales,</p>
                                    <br>
                                    <p>Estimado/a <strong>${fullName}</strong>,</p>
                                    <br>
                                    <p>Tu postulación a la oferta laboral <strong>${oferta.cargo}</strong> de la empresa <strong>${oferta.empresa.nombre}</strong> realizada en el portal de
                                        empleo de la ISTA se ha retirado.</p>
                                    <br>
                                    <p>Esta acción no se puede deshacer.</p>
                                    <br>
                                    <p>Si te has arrepentido, puedes volver a postularte a la misma oferta laboral
                                        ingresando a nuestro portal de empleo.</p>
                                    <br>
                                    <p>Si tienes alguna duda o inquietud, no dudes en contactarnos.</p>
                                    <br>
                                    <p>Recuerda que el equipo de ISTA está para ayudarte en todo lo que necesites.</p>
                                    <br>
                                    <p>¡Gracias por atender este comunicado!</p>
                                    <p>El equipo de ISTA.</p>
                                </div>
                                <div class="center-icon">
                                    <img src="https://i.postimg.cc/7G2S7n52/logo-ista.png" alt="logo-ista" width="1000px">
                                </div>
                                <br>
                                <hr>
