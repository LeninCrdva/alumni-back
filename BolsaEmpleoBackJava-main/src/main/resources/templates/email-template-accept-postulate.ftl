                        ...
                        <td align="center" valign="top"
                            ...
                            <body>
                                ...
                                <div class="center-text">
                                    ...
                                    <br>
                                    <p>Felicitaciones, tu postulación a la oferta laboral <strong>${oferta.cargo}</strong> de la empresa <strong>${oferta.empresa.nombre}</strong> ha sido
                                        seleccionada.</p>
                                    <br>
                                    ...
                                    <br>
                                    <p>Un representante de la empresa se pondrá en contacto contigo para continuar con el proceso de selección.</p>
                                    <br>
