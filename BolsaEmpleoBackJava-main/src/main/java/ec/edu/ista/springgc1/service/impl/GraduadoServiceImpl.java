	...
	private GraduadoRepository graduadoRepository;
	  @Autowired
	    ...
	    public Graduado mapToEntity(GraduadoDTO estudianteDTO) {
	        ...
	        estudiante.setUrl_pdf(estudianteDTO.getRuta_pdf() == null ? null : s3Service.getObjectUrl(estudianteDTO.getRuta_pdf()));
	    ...
	    public GraduadoDTO findByUsuario(long id_usuario) {
	        ...
	        estudiante.setUrl_pdf(estudiante.getRuta_pdf() == null ? null : s3Service.getObjectUrl(estudiante.getRuta_pdf()));
	        return mapToDTO(estudiante);
	    }
